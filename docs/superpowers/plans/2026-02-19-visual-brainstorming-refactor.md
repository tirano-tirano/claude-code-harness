...
> **For agentic workers:** REQUIRED: Use claude-code-harness:subagent-driven-development (if subagents available) or claude-code-harness:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
